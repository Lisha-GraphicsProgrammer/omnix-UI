...
function VisionMetaphor() {
  ...
  return (
    ...
    >
          ...
          background:
            step === 0
              ...
              : step === 1
                ...
                : step === 2
                  ? "radial-gradient(ellipse at 50% 80%, rgba(110,231,183,0.05) 0%, transparent 60%)"
      ...
      <Box
        sx={{ display: "flex", gap: 1, mb: 3, position: "relative", zIndex: 1 }}
      >
        {steps.map((s, i) => (
          <Box key={i} sx={{ flex: 1 }}>
            <Box
            ...
            <Typography
              sx={{
                color: i <= step ? s.color : "rgba(255,255,255,0.18)",
                fontSize: ".6rem",
        ...
        {step === 0 && (
          ...
          >
            ...
            >
              ...
              />
              <Typography
                sx={{ color: "rgba(255,255,255,0.15)", fontSize: ".6rem" }}
              >
                Sending to AI →
              </Typography>
            </Box>
                ...
                {[0, 1, 2].map((d) => (
                  <Box
                    ...
                    sx={{
                      ...
                      "@keyframes dot": {
                        "0%,100%": { opacity: 0.2, transform: "scale(.8)" },
            ...
            {[
              ...
              <Box
                ...
                sx={{
                  ...
                  animation: `fi .35s ease ${i * 0.08}s both`,
                  "@keyframes fi": {
        ...
        {step === 2 && (
          <Box sx={{ display: "flex", flexDirection: "column", gap: 0.8 }}>
            ...
            >
              ...
              >
                CV Pipeline Deployed
              </Typography>
            </Box>
            {[
              {
                icon: "📹",
                label: "RTSP Stream Ingestion",
                status: "active",
                c: "#6ee7b7",
                pct: 100,
              },
              ...
              <Box
                key={i}
                sx={{
                  animation: `si .25s ease ${i * 0.07}s both`,
                  "@keyframes si": {
                    from: { opacity: 0, transform: "translateX(8px)" },
                    to: { opacity: 1, transform: "none" },
                  },
              ...
              >
                ...
                >
                  <Box component="span" sx={{ fontSize: ".75rem" }}>
                    {item.icon}
                  </Box>
                  <Typography
                    sx={{
                  ...
                  <Typography
                    sx={{ color: item.c, fontSize: ".6rem", fontWeight: 700 }}
                  >
                    {item.status}
                  </Typography>
                </Box>
                ...
                >
                  <Box
                    sx={{
                      height: "100%",
                      width: `${item.pct}%`,
                      background: `linear-gradient(90deg, ${item.c}80, ${item.c})`,
                      borderRadius: 1,
                      transition: "width 1.2s ease",
                      boxShadow: `0 0 6px ${item.c}60`,
                    }}
                  />
                </Box>
              </Box>
          ...
          >
            ...
            >
              <Box
                sx={{
                  ...
                  "@keyframes bl": {
                    "0%,100%": { opacity: 1, boxShadow: "0 0 10px #ef4444" },
              ...
              >
                VIOLATION DETECTED — HIGH SEVERITY
              </Typography>
              <Typography
                sx={{
            ...
            >
              ...
              >
                ...
                · No helmet · Loading zone entry · 59 frames
              </Typography>
                ...
                {[
                  ...
                  <Box
                    ...
                    sx={{
                      ...
                      alignItems: "center",
                      gap: 0.5,
                      animation: `fb .3s ease ${i * 0.1}s both`,
                      "@keyframes fb": {
    ...
    <Box sx={{ minHeight: "100vh", display: "flex", background: "#08080a" }}>
      ...
      >
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
            <Box
              sx={{
                ...
                boxShadow:
                  "0 0 20px rgba(99,102,241,0.4), 0 0 0 1px rgba(255,255,255,0.1)",
              }}
            >
          ...
          <Box sx={{ display: "flex", gap: 1 }}>
            {["SOC 2", "ISO 27001", "GDPR"].map((b) => (
              ...
              >
                <Typography
                  sx={{ color: "rgba(255,255,255,0.28)", fontSize: ".6rem" }}
                >
                  ✓ {b}
                </Typography>
              </Box>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          >
            Type what you want to detect. OMNIX converts your instruction into a
            production-grade CV pipeline instantly.
          </Typography>
        </Box>
        ...
        >
          <Box sx={{ width: "100%", maxWidth: 360 }}>
            <Box sx={{ mb: 6 }}>
              ...
              >
                Sign in to access your OMNIX monitoring dashboard
              </Typography>
            </Box>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2.5 }}>
                  ...
                  input: {
                    startAdornment: (
                      <InputAdornment position="start">
                        <EmailIcon
                          sx={{ color: "rgba(255,255,255,0.3)", fontSize: 17 }}
                        />
                      </InputAdornment>
                    ),
                  },
              ...
              >
                ...
                >
                  ...
                  />
                  <Typography
                    sx={{ color: "rgba(255,255,255,0.25)", fontSize: ".78rem" }}
                  >
                    Remember me
                  </Typography>
                </Box>
              ...
              <Button
                ...
                sx={{
                  ...
                  boxShadow: loading
                    ? "none"
                    : "0 4px 20px rgba(99,102,241,0.28), inset 0 1px 0 rgba(255,255,255,0.12)",
                  border: "1px solid rgba(99,102,241,0.3)",
                  transition: "all .2s ease",
                  "&:hover": {
                    background:
                      "linear-gradient(135deg, #5558e8 0%, #6d28d9 100%)",
            ...
            <Box
              sx={{ display: "flex", alignItems: "center", gap: 2, my: 3.5 }}
            >
              <Box
                sx={{
                  flex: 1,
              ...
              />
              <Typography
                sx={{ color: "rgba(255,255,255,0.18)", fontSize: ".72rem" }}
              >
                or
              </Typography>
              <Box
            ...
            >
              ...
              >
                {[
                  ...
                  >
                    <Box component="span" sx={{ fontSize: ".78rem" }}>
                      {item.icon}
                    </Box>
                    <Typography
                      sx={{
